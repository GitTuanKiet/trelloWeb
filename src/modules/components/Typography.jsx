...
const markClassesMapping = {
  center: {
    h1: '',
    h2: 'TrelloKTypography-markedH2Center',
    h3: 'TrelloKTypography-markedH3Center',
    h4: 'TrelloKTypography-markedH4Center',
    h5: '',
    h6: ''
  },
  left: {
    ...
    h4: '',
    h5: '',
    h6: 'TrelloKTypography-markedH6Left'
  },
  none: {
    h1: '',
    h2: '',
...
const StyledTypography = styled(Typography)(styles)
